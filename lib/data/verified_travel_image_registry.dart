...
const verifiedTravelImageRegistry = <String, SpotImageInfo>{
  'ankara-kale': SpotImageInfo(
    ...
    networkUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Ankara_Castle.jpg?width=1280',
  ...
  'safranbolu': SpotImageInfo(
    ...
    networkUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Safranbolu_06609_20070130130656.jpg?width=1280',
    sourceName: 'Wikimedia Commons',
    author: 'Nevit Dilmen',
    license: 'CC BY-SA 3.0',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Safranbolu_06609_20070130130656.jpg',
  ),
  'assos': SpotImageInfo(
    assetPath: 'assets/spots/assos.jpg',
    networkUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Assos_%281995%29_19_%287902773580%29.jpg?width=1280',
    sourceName: 'Wikimedia Commons',
    author: 'Carl Campbell',
    license: 'CC BY 2.0',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Assos_(1995)_19_(7902773580).jpg',
  ),
  'bodrum-kale': SpotImageInfo(
    assetPath: 'assets/spots/bodrum-kale.jpg',
    networkUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/TurkeyBodrumCastle.jpg?width=1280',
    sourceName: 'Wikimedia Commons',
    author: 'Horvat',
  ...
  'salda': SpotImageInfo(
    ...
    networkUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Lake_Salda_Nature_Park_1.jpg?width=1280',
    sourceName: 'Wikimedia Commons',
    author: 'Shanti Alex',
  ...
  'konya-mevlana': SpotImageInfo(
    ...
    networkUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Molavi1.JPG?width=1280',
    sourceName: 'Wikimedia Commons',
    author: 'دانقولا',
    license: 'CC0 1.0',
  ...
  'goreme-acik-hava': SpotImageInfo(
    ...
    networkUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Churches_in_G%C3%B6reme_11.jpg?width=1280',
    sourceName: 'Wikimedia Commons',
    author: 'Antoine Taveneaux',
    license: 'CC BY-SA 3.0',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Churches_in_G%C3%B6reme_11.jpg',
  ),
  'harput-kalesi': SpotImageInfo(
    assetPath: 'assets/spots/harput-kalesi.jpg',
    networkUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Festung_Harput.jpg?width=1280',
    sourceName: 'Wikimedia Commons',
