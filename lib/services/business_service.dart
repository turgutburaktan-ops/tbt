...
class BusinessService {
  ...
  Future<Map<String,dynamic>> startPremiumTrial(String category,String venueId) async {final r=await _functions.httpsCallable('startBusinessPremiumTrial').call({'venueKey':venueKey(category.trim(),venueId.trim())});return Map<String,dynamic>.from(r.data as Map);}
