...
class AuthService {
  ...
  // OAuth client IDs are public identifiers. Keep the Firebase Web client ID
  // in source so a stale/mistyped CI secret cannot break Android sign-in with
  // ApiException 10 after an otherwise successful Play release.
