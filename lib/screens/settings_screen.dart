...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _soon(String text) => ScaffoldMessenger.of(
    context,
  ).showSnackBar(SnackBar(content: Text('$text yakında kullanıma açılacak.')));
                ...
                return ListView(
                  ...
                  children: [
                    ...
                    _tile(
                      ...
                      'Profil bilgileri',
                      'Ad, kullanıcı adı, biyografi ve profil türü',
                      () => _soon('Profil düzenleme'),
                    ),
                    _tile(
                      Icons.lock_outline_rounded,
                      'Şifre ve güvenlik',
                      'E-posta, telefon ve şifre güvenliği',
                      () => _soon('Hesap güvenliği'),
                    ),
                    _tile(
                      Icons.verified_user_outlined,
                      'Doğrulama',
                      'Hesap ve doğrulama durumunu gör',
                      () => _soon('Doğrulama merkezi'),
                    ),
                    _title('Gizlilik'),
                    _switch(
                    ...
                    if (type == 'business_owner' ||
                      ...
                      _tile(
                        ...
                        'Mekan taleplerim',
                        'Sahiplik ve yönetici taleplerinin durumunu gör',
                        () => _soon('Mekan talepleri'),
                      ),
                    ],
                    if (type == 'organizer') ...[
                      _title('Organizatör'),
                      _tile(
                        ...
                        'Etkinlik yönetimi',
                        'Oluşturduğun ve yönettiğin etkinlikleri kontrol et',
                        () => _soon('Etkinlik yönetimi'),
                      ),
                    ],
                    _title('Uygulama'),
                    _tile(
                    ...
                    _tile(
                      ...
                      'Veri ve depolama',
                      'Video kalitesi, mobil veri ve önbellek',
                      () => _soon('Veri ve depolama'),
                    ),
                    _tile(
                      Icons.help_outline_rounded,
                      'Yardım ve destek',
                      'Yardım merkezi, kurallar ve geri bildirim',
                      () => _soon('Yardım merkezi'),
                    ),
                    _tile(
                      Icons.info_outline_rounded,
                      'TBT hakkında',
                      'Gizlilik, kullanım şartları ve sürüm bilgisi',
                      () => _soon('TBT hakkında'),
                    ),
