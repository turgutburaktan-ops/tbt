...
class _StoryPhotoEditorScreenState extends State<StoryPhotoEditorScreen> {
  ...
  Future<void> _addPhotos() async {
    ...
    try {
      ...
      final remaining = math.max(
        0,
        4 - _overlays.where((e) => e.photo != null).length,
      );
      ...
      if (files.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'Bir Story karesine en fazla 4 ek fotoğraf koyabilirsin.',
            ),
          ),
        );
        return;
  ...
  void _updateBackgroundGesture(ScaleUpdateDetails details) {
    ...
    setState(() {
      ...
      _backgroundScale = (_backgroundStartScale * details.scale)
          .clamp(1.0, 6.0)
          .toDouble();
  ...
  double _renderPixelRatio(RenderRepaintBoundary boundary) {
    ...
    return math.max(deviceRatio, 1 / cover).toDouble();
  }
                  ...
                  child: Stack(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        onTap: _drawing || _editingBackground
                            ? null
              ...
              children: [
                    ...
                    child: _ModePanel(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 9),
                          IconButton(
                            onPressed: _strokes.isEmpty ? null : _undoDraw,
                ...
                if (_editingBackground)
                  Align(
                    ...
                    child: _ModePanel(
                      title: 'Kadraj',
                      done: _toggleBackgroundEdit,
                      child: const Padding(
                        padding: EdgeInsets.only(top: 4),
                        child: Text(
                          'Sürükle\nİki parmakla ölçekle ve döndür',
          ...
          onScaleUpdate: _drawing || _editingBackground
              ...
              : (details) {
                  ...
                  setState(() {
                    ...
                    item.scale = (item.gestureStartScale * details.scale)
                        .clamp(.2, 7.0)
                        .toDouble();
                    item.rotation =
                        item.gestureStartRotation + details.rotation;
              ...
              child: item.photo != null
                  ? Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: selected && !_movingOverlay
...
class _DrawingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    for (final stroke in <_DrawStroke>[
      ...strokes,
