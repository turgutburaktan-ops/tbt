  ...
  Future<void> _addPhotos() async {
    ...
    try {
      ...
      final remaining = math.max(
        0,
        4 - _overlays.where((item) => item.photo != null).length,
      );
                      ...
                      onScaleUpdate: !_editingBackground
                          ...
                          : (details) {
                              setState(() {
                                ...
                                _backgroundScale =
                                    (_backgroundStartScale * details.scale)
                                        .clamp(1.0, 6.0);
                                _backgroundRotation =
                                    _backgroundStartRotation + details.rotation;
                              });
                            },
              ...
              Row(
                children: [
                  ...
                  _CircleButton(
                    ...
                    onTap: _sharing ? null : _addPhotos,
                  ),
                  const SizedBox(width: 7),
                  _CircleButton(
                    icon: _editingBackground
                        ? Icons.check_rounded
                        : Icons.zoom_out_map_rounded,
                    onTap: _sharing ? null : _toggleBackgroundEdit,
                  ),
                  const SizedBox(width: 7),
                  _CircleButton(
          ...
          onScaleUpdate: _drawing || _editingBackground
              ...
              : (details) {
                  ...
                  setState(() {
                    ...
                    item.scale = (item.gestureStartScale * details.scale).clamp(
                      .2,
                      7.0,
                    );
                    item.rotation =
