...
class _SpotSuggestionScreenState extends State<SpotSuggestionScreen> {
  final _name = TextEditingController(),
      ...
      _whyVisit = TextEditingController();
  ...
  Future<void> _useCurrentLocation() async {
    ...
    try {
      ...
      if (mounted) setState(() => _pickedLocation = point);
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
              ...
              markers: _pickedLocation == null
                  ...
                  : {
                      Marker(
                        ...
                        draggable: true,
                        onDragEnd: (p) => setState(() => _pickedLocation = p),
                      ),
                    },
          ...
          const Text(
            'İki parmakla yakınlaştırıp uzaklaştır, haritayı sürükle ve yerin tam noktasına dokun. Kırmızı pini basılı tutup sürükleyerek de ince ayar yapabilirsin.',
            style: TextStyle(
