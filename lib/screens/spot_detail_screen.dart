...
class SpotDetailScreen extends StatelessWidget {
  ...
  String get _visitTitle =>
      _isAnitkabir ? 'Neden Ziyaret Etmeli?' : 'Neden Gitmeli?';
          ...
          SliverAppBar(
            ...
            actions: [
              IconButton(
                ...
                onPressed: () => InviteLinkService.instance.shareSpot(
                  spotId: spot.id,
                  spotName: spot.name,
                  city: spot.city,
          ...
          SliverPadding(
            ...
            sliver: SliverList.list(
              children: [
                ...
                Text(
                  '${spot.city} • ${spot.category} • ⭐ ${spot.rating.toStringAsFixed(1)}',
                  style: const TextStyle(
                    ...
                    Expanded(
                      child: FilledButton.icon(
                        onPressed: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => CameraScreen(initialSpot: spot),
                          ),
                        ),
                        icon: const Icon(Icons.camera_alt_outlined),
                        label: const Text('Burada Çek'),
                      ),
                    ),
