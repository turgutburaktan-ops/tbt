            ...
            children: [
              const Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Sosyal Etkinlikler', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900)),
                    SizedBox(height: 3),
                    Text('Birlikte çık, koş, sür, kamp yap veya buluş.', style: TextStyle(color: Colors.white60)),
                  ],
                ),
              ),
                ...
                return const Center(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.groups_outlined, size: 58, color: Colors.white30),
                        SizedBox(height: 12),
                        Text('Yaklaşan etkinlik yok', style: TextStyle(fontWeight: FontWeight.w800)),
                        SizedBox(height: 6),
                        Text('İlk etkinliği sen oluşturabilirsin.', style: TextStyle(color: Colors.white54)),
                      ],
                    ),
                  ),
                );
