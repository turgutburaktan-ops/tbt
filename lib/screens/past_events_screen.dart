...
class PastEventsScreen extends StatelessWidget {
  ...
  Widget _body(BuildContext context) {
    ...
    if (uid == null)
      return const Center(
        child: Text('Geçmiş etkinliklerin için giriş yapmalısın.'),
      );
        ...
        if (snapshot.hasError)
          return Center(
            child: Padding(
              ...
              child: Text(
                'Geçmiş etkinlikler yüklenemedi.\n${snapshot.error}',
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 12),
                  Text(
                    'Henüz geçmiş etkinliğin yok.',
                    style: TextStyle(fontWeight: FontWeight.w900),
                  ),
                  SizedBox(height: 6),
                  Text(
                    'Katıldığın etkinlikler başladıktan sonra burada anı albümüne dönüşecek.',
                    textAlign: TextAlign.center,
