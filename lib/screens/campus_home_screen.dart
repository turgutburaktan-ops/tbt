    ...
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snap) {
        ...
        final campusEligible =
            university.isNotEmpty && activeStudentYears.contains(classYear);
        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          const Text(
                            'Kampüs profili aktif',
                            style: TextStyle(fontWeight: FontWeight.w900),
                          ),
                          const SizedBox(height: 2),
                          Text(
                            '$university • ${classYear == 'Hazırlık' ? 'Hazırlık' : '$classYear. sınıf'}',
                            style: const TextStyle(
                              color: Colors.white60,
                              fontSize: 11.5,
                            ),
              ...
              if (newStudent)
                _WelcomeCard(department: department, classYear: classYear),
          ...
          () => Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) => ActivityDemandScreen(
                initialActivity: interests.isEmpty
                    ? 'Fotoğraf'
                    : interests.first,
              ),
            ),
    ...
    builder: (context, snap) {
      ...
      return Column(
        ...
        children: [
          ...
          if (items.isEmpty)
            const _Empty(
              'Henüz talep yok. Ne yapmak istediğini seçerek ilk talebi oluştur.',
            )
          else
            Wrap(
              spacing: 8,
                  ...
                  .map(
                    (e) => ActionChip(
                      ...
                      onPressed: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              ActivityDemandScreen(initialActivity: e.key),
                        ),
                      ),
                    ),
                  )
    ...
    builder: (context, snap) {
      ...
      return Column(
        ...
        children: [
          ...
          if (docs.isEmpty)
            const _Empty(
              'Henüz topluluk yok. Tüm toplulukları keşfet veya ilk topluluğu oluştur.',
            )
          else
            SizedBox(
              height: 118,
                ...
                itemBuilder: (_, i) {
                  ...
                  return InkWell(
                    onTap: () => Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) =>
                            CommunityProfileScreen(communityId: docs[i].id),
                      ),
                    ),
                    child: Container(
                      width: 170,
