            ...
            children: [
              ...
              SizedBox(
                ...
                child: FilledButton(
                  onPressed: () async {
                    try {
                      await CommunityService.instance.createCommunity(
                        name: name.text,
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                if (docs.isEmpty)
                  return const Center(
                    child: Text('Bu üniversitede henüz topluluk yok.'),
                  );
                    ...
                    return Card(
                      ...
                      child: InkWell(
                        onTap: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                CommunityProfileScreen(communityId: id),
                          ),
                        ),
                        child: Padding(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    StreamBuilder<int>(
                                      stream: CommunityService.instance
                                          .followerCount(id),
                                      builder: (_, s) => Text(
                                        '${s.data ?? 0} takipçi',
                                        style: const TextStyle(
                                    ...
                                    onPressed: () => Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (_) => InviteQrScreen(
                                          title: name,
                                          subtitle: university,
                                          uri: InviteLinkService.instance
                                              .communityUri(id),
                                        ),
                                      ),
                                    ),
