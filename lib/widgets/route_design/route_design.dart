        ...
        gradient:
            onPressed == null
                ...
                : const LinearGradient(
                  colors: [Color(0xFF22CBD5), Color(0xFF6950EC)],
                ),
          ...
          child: Padding(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color:
                      value == mode ? AppColors.selection : AppColors.surface,
                  border: Border.all(
                    color: value == mode ? AppColors.cyan : AppColors.border,
                  ),
                  borderRadius: BorderRadius.circular(16),
                ),
                child: Column(
                  children: [
                    Icon(
                      icon(mode),
                      color:
                          value == mode ? AppColors.cyan : AppColors.textMuted,
                    ),
