...
class _StoryViewerScreenState extends State<StoryViewerScreen>
  ...
  Widget _media(AppStory s) => s.isVideo && s.videoUrl.isNotEmpty
        ...
        children: [
          Positioned.fill(
            child: PageView.builder(
              ...
              itemBuilder: (_, i) => _media(_stories[i]),
            ),
          ),
          Positioned.fill(
            child: GestureDetector(
          ...
          Positioned(
            ...
            child: _mine
                ...
                : StreamBuilder<Map<String, dynamic>>(
                    ...
                    builder: (_, snapshot) {
                      final liked =
                          (snapshot.data ?? const <String, dynamic>{})['liked'] ==
                              true;
                      return Row(
                        children: [
                          Expanded(
                          ...
                          IconButton(
                            onPressed: () =>
                                StoryService.instance.setLiked(current, !liked),
                            icon: Icon(
                              liked
