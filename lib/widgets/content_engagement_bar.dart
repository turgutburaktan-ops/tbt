      ...
      builder: (sheetContext) => Padding(
        ...
        child: SizedBox(
          ...
          child: Column(children: [
            ...
            Expanded(child: ShareRecipientPicker(onSelected: (user) => Navigator.pop(sheetContext, user))),
          ]),
        ),
      ),
    );
