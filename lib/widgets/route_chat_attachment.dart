...
class RouteChatAttachment extends StatefulWidget {
  const RouteChatAttachment({
    super.key,
  ...
  final String planId, messageId;
  final Map<String, dynamic> data;
  final bool mine;
  @override
  State<RouteChatAttachment> createState() => _RouteChatAttachmentState();
}

class _RouteChatAttachmentState extends State<RouteChatAttachment> {
  File? _file;
