      ...
      return Theme(
        data: base.copyWith(
          colorScheme: base.colorScheme.copyWith(
            primary: ChatSurface.accent, onPrimary: ChatSurface.background,
            secondary: ChatSurface.accent, onSecondary: ChatSurface.background,
            primaryContainer: const Color(0xFF203C62),
            onPrimaryContainer: const Color(0xFFE8F1FF),
            surface: ChatSurface.panel, onSurface: const Color(0xFFF0F5FF),
          ),
          scaffoldBackgroundColor: background,
          appBarTheme: base.appBarTheme.copyWith(
            backgroundColor: background, surfaceTintColor: Colors.transparent,
            foregroundColor: Colors.white,
            titleTextStyle: const TextStyle(fontSize: 22, fontWeight: FontWeight.w700, color: Color(0xFFF0F5FF)),
          ),
          inputDecorationTheme: base.inputDecorationTheme.copyWith(
            filled: true, fillColor: ChatSurface.panel,
            prefixIconColor: ChatSurface.accent,
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(24), borderSide: BorderSide.none),
            enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(24), borderSide: BorderSide.none),
            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(24), borderSide: const BorderSide(color: ChatSurface.accent)),
          ),
          chipTheme: base.chipTheme.copyWith(
            backgroundColor: ChatSurface.panel, selectedColor: const Color(0xFF203C62),
