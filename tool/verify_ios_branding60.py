...
with zipfile.ZipFile(ipas[0]) as archive:
 ...
 assert info['CFBundleShortVersionString']=='1.0.32'
 assert info['CFBundleVersion']=='60'
...
print('Verified TBT logo source, compiled AppIcon and com.tbt.social 1.0.32 (60)')
