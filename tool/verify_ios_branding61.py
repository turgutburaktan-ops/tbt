...
with zipfile.ZipFile(ipas[0]) as archive:
 ...
 assert info['CFBundleShortVersionString']=='1.0.33'
 assert info['CFBundleVersion']=='61'
 assert info['GADApplicationIdentifier']=='ca-app-pub-3462343788063276~3452529921'
 ids={item['SKAdNetworkIdentifier'] for item in info['SKAdNetworkItems']}
 assert 'cstr6suwn9.skadnetwork' in ids and len(ids)>=50, 'Missing AdMob attribution configuration'
 assert info.get('NSUserTrackingUsageDescription'), 'Missing tracking explanation'
...
print('Verified TBT logo source, compiled AppIcon and com.tbt.social 1.0.33 (61)')
