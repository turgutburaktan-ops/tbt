...
import '../lib/screens/today_plan_screen.dart';
import '../lib/services/video_audio_session.dart';
import '../lib/widgets/playback_indexed_stack.dart';
...
import '../lib/services/app_notification_service.dart';
import '../lib/services/chat_service.dart';
import '../lib/services/nearby_venue_service.dart';
import '../lib/theme/app_theme.dart';
import '../lib/widgets/nearby_places_view.dart';
import '../lib/widgets/story_strip.dart';
import '../lib/widgets/tbt_brand_mark.dart';
import '../lib/screens/campus_home_screen.dart';
import '../lib/screens/chat_inbox_screen.dart';
import '../lib/screens/collaborative_plans_screen.dart';
import '../lib/screens/event_create_screen_v2.dart';
import '../lib/screens/event_photo_create_screen.dart';
import '../lib/screens/feed_screen.dart';
import '../lib/screens/home_discover_screen.dart';
import '../lib/screens/login_screen.dart';
import '../lib/screens/main_camera_screen.dart';
import '../lib/screens/map_screen.dart';
import '../lib/screens/profile_page_v2.dart';
import '../lib/screens/public_travel_plans_screen.dart';
import '../lib/screens/radar_screen.dart';
import '../lib/screens/route_planner_screen.dart';
import '../lib/screens/smart_plan_screen.dart';
import '../lib/screens/spot_explore_screen_v2.dart';
import '../lib/screens/travel_plans_screen.dart';
...
class _BottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final items = [
      ...
      (Icons.explore_outlined, Icons.explore_rounded, 'Rota'),
...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: RepaintBoundary(
            key: boundary,
            child: _PlanningHub(onOpenNearby: () {}),
          ),
        ),
      );
      ...
      expect(find.text('Türkiye’yi keşfet'), findsOneWidget);
